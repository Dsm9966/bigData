...
* 需要进行进栈出栈操作彻底解决
	...
	*  3.git stash pop  将我们的本地代码进行出栈(远端代码和本地代码有冲突的部分会出现
...
![17.png](https://upload-images.jianshu.io/upload_images/14466577-282560e1b6713221.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
