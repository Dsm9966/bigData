...
* 6.2创建一个div作为容器	`<div id="main" style="width: 600px;height:400px;"></div>`
* 6.3初始化	`var myChart = echarts.init(document.getElementById('main'));	`
* 6.4设置需要的属性 http://echarts.baidu.com/examples/
* 6.5使用指定的配置	`myChart.setOption(option);`	
