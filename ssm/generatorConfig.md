...
<generatorConfiguration>
    ...
    <context id="default" targetRuntime="MyBatis3Simple" defaultModelType="flat">
        ...
        <plugin type="tk.mybatis.mapper.generator.MapperPlugin">
            <property name="mappers" value="com.lanou.secondboot.util.MyMapper"/>
        </plugin>
        ...
        <jdbcConnection
                ...
                connectionURL="jdbc:mysql://192.168.197.148:3306/dsm?characterEncoding=utf-8"
                userId="root"
                password="123">
        </jdbcConnection>
        ...
        -->
        <javaModelGenerator targetPackage="com.lanou.secondboot.model" targetProject="./src/main/java">
        ...
        <javaClientGenerator type="XMLMAPPER" targetPackage="com.lanou.secondboot.dao" targetProject="./src/main/java">
